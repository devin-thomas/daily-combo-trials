...
- Both providers are configured; live pageview collection and dashboard
  confirmation await the activation deployment and are **unverified**. All four events are
